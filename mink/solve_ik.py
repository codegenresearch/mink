...
This code snippet removes any stray text comments that might have been causing the `SyntaxError`. The code should now be syntactically correct and ready for testing.