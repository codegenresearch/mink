...
class Contact:
    ...
    Attributes:
        ...
        fromto: An array representing the two closest points on the geoms.
...
class CollisionAvoidanceLimit(Limit):
    ...
    def _compute_contact_with_minimum_distance(
        ...
        Returns:
            A Contact object representing the contact information.
        """
        fromto = np.empty(6)
    ...
    def _construct_geom_id_pairs(self, geom_pairs: CollisionPairs) -> List[tuple[int, int]]:
        ...
        - Geoms that are part of the same body or weld are not included.
        - Geoms where the body of one geom is a parent of the body of the other
          geom are not included.
        - Geoms that fail the contype-conaffinity check are ignored.
