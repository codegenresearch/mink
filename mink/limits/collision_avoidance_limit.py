...
class CollisionAvoidanceLimit(Limit):
    ...
    def _convert_geom_identifiers_to_ids(self, geom_list: GeomSequence) -> List[int]:
        """Converts a list of geom identifiers (IDs or names) to a list of IDs."""
        geom_ids = []
    ...
    def _convert_collision_pairs_to_geom_id_pairs(self, collision_pairs: CollisionPairs):
        ...
        for collision_pair in collision_pairs:
            id_pair_1 = self._convert_geom_identifiers_to_ids(collision_pair[0])
            id_pair_2 = self._convert_geom_identifiers_to_ids(collision_pair[1])
            id_pair_1 = list(set(id_pair_1))
            id_pair_2 = list(set(id_pair_2))
            geom_id_pairs.append((id_pair_1, id_pair_2))
