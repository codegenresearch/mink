...
3. **Type Annotations**: Changed `List[int]` to `list[int]` for type hints to match the gold code.
...
7. **Consistency in Comments**: Ensured that comments are consistent in style and format throughout the code. Removed any extraneous characters or incorrect formatting.
8. **Functionality Alignment**: Made sure that the functionality of the code matches that of the gold code, ensuring that it performs the same operations in a similar manner.
