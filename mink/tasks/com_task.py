...
class ComTask(Task):
    ...
    def set_target(self, target_com: npt.ArrayLike) -> None:
        ...
        Raises:
            InvalidTarget: If the target CoM position is not a valid vector of shape (3,).
        """
    ...
    def compute_jacobian(self, configuration: Configuration) -> np.ndarray:
        ...
        The task Jacobian :math:`J(q) \in \mathbb{R}^{3 \times n_v}` is the derivative of
        the CoM position with respect to the current configuration :math:`q`.
