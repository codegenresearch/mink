...
class TestUtils(absltest.TestCase):
    ...
    def test_custom_configuration_vector_raises_error_if_joint_shape_invalid(self):
    ...
    def test_get_subtree_geom_ids(self):
        ...
        actual_geom_ids = utils.get_subtree_geom_ids(model, b2_id)
...
def get_subtree_body_ids(model, body_id):
    """Get the body IDs of a subtree rooted at the2 the given body ID."""
    body_ids = [body_id]
