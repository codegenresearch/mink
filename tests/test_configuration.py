...
import mink
from mink import Configuration, InvalidFrame, UnsupportedFrame, InvalidKeyframe, NotWithinConfigurationLimits
...
class TestConfiguration(absltest.TestCase):
    ...
    def test_nq_nv(self) -> None:
        configuration: Configuration = Configuration(self.model)
    ...
    def test_inplace_integration(self) -> None:
        configuration: Configuration = Configuration(self.model, self.q_ref)
    ...
    def test_check_limits(self) -> None:
        ...
        configuration: Configuration = Configuration(self.model, q=self.q_ref)
